...
const ParallaxBackground = () => {
  ...
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden">
      {theme === "light" && (
        <>
          <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-gradient-to-br from-cyan-200/30 to-blue-300/20 rounded-full blur-3xl animate-float" />
          <div className="absolute top-[60%] right-[-5%] w-[30%] h-[40%] bg-gradient-to-br from-fuchsia-200/25 to-purple-300/15 rounded-full blur-3xl animate-float-delayed" />
          <div className="absolute top-[40%] left-[20%] w-[25%] h-[30%] bg-gradient-to-br from-amber-200/20 to-yellow-300/15 rounded-full blur-3xl animate-float-slow" />
        </>
      )}
      {theme === "dark" && (
        <>
